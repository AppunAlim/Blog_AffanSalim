                ...
                <div class="card-body">
                    ...
                    <form class="row g-3 mt-2" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <textarea type="text" class="form-control" name="deskripsi" id="editor" required="true" placeholder="Deskripsi Disini"></textarea>
                        </div>
                        <div class="col-12">
...
if (isset($_POST['submit'])) {
    ...
    $queryInsert = "INSERT INTO artikel(judul,kategori,deskripsi,status,filename)
                     VALUE ('$judul','$kategori','$deskripsi','$status','$image_name')";
