                ...
                <div class="card-body">
                    ...
                    <form class="row g-3 mt-2" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <textarea type="text" class="form-control" name="deskripsi" id="editor" required="true" placeholder="Deskripsi Disini" ><?=$deskripsi?></textarea>
                        </div>
                        <div class="col-12">
                            <label for="inputAddress2" class="form-label">Status</label>
                            <select name="status" value="<?=$status;?>" class="form-select" required="true">
                                <option value="">Choose</option>
                                <option value="Published" 
                                <?php if($status =="Published") echo "selected";  ?>
                                >Published</option>
                                <option value="Unpublished"
                                <?php if($status =="Unpublished") echo "selected";  ?>
                                >Unpublished</option>
                            </select>
                        </div>
